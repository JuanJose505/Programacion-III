...
namespace BibliotecaDigital.Modelos
{
    public class Libro : MaterialBiblioteca, IPrestable
    {
        ...
        public Libro(int id, string titulo, string autor, int yearpublication, string categoria, int isbn, int numero_paginas) :base(id, titulo, autor, yearpublication,categoria)
        {
